...
\033[1;91mTelegram\033[1;91m: \033[1;93mt.me/haji_ali_back
\033[1;91minstagram\033[1;91m: \033[1;93mHaji Ali HaZara
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:H4ji Al1
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://t.me/joinchat/AAAAAEna_ZHQHhskOjc5fg')
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:WE_ARE_HaZaRisTaN.
	print logo
...
def pilih_super():
	...
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	jalan(' \033[1;93mPlz Wait Haji Ali start Hacking now')
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	...
	print """                                              
                       ,,   ,,                      ,,    ,,  
`7MMF'  `7MMF'         db   db            db      `7MM    db  
  MM      MM                             ;MM:       MM        
  MM      MM   ,6"Yb.`7MM `7MM          ,V^MM.      MM  `7MM  
  MMmmmmmmMM  8)   MM  MM   MM         ,M  `MM      MM    MM  
  MM      MM   ,pm9MM  MM   MM         AbmmmqMA     MM    MM  
  MM      MM  8M   MM  MM   MM        A'     VML    MM    MM  
.JMML.  .JMML.`Moo9^Yo.MM .JMML.    .AMA.   .AMMA..JMML..JMML.
                    QO MP                                     
                    `bmP                                      
                      No love Ali
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
